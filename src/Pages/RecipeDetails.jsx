    ...
    <div className="mx-2">
      <div className="flex flex-col lg:flex-row gap-10 items-center py-15 my-8 bg-white shadow-md rounded-2xl overflow-hidden p-6 space-y-6 lg:space-y-0 lg:space-x-6 max-w-5xl mx-auto">
        ...
        <div className="w-full lg:w-1/2 flex flex-col ">
          ...
          <button onClick={hendelLike} className="mt-4 bg-primary hover:bg-secondary text-white px-4 py-1.5 rounded-full font-bold w-fit flex items-center gap-2">
          {showLike?<AiFillLike size={24} /> :<AiOutlineLike size={23} />} Like
          </button>
        </div>
